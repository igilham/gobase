...
ALL_TARGETS=cksum echo false ls mkdir pwd rm seq sleep tee touch true whoami yes $(TESTABLE_TARGETS)
TESTABLE_TARGETS=gobase basename cat dirname head sort uniq wc
